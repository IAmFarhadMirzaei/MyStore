...
class ShippingAddress(models.Model):
    ...
    shipping_email = models.CharField(max_length=70)
    ...
    shipping_zipcode = models.CharField(max_length=30, blank=True, null=True)
    shipping_country = models.CharField(max_length=30, default='IRAN')
